...
public class PokerClockChangeConfirmationDialogFragment extends DialogFragment {

	private final static String sTag = PokerClockChangeConfirmationDialogFragment.class.getSimpleName();
	private final ConfirmationPromptClickListener listener = new ConfirmationPromptClickListener();
	public static PokerClockChangeConfirmationDialogFragment getInstance(Bundle args) {
		PokerClockChangeConfirmationDialogFragment fragment = new PokerClockChangeConfirmationDialogFragment();
